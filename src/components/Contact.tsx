          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 order-2 md:order-1">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.instagram.com/podipoint/" className="w-10 h-10 rounded-full bg-podipoint-green flex items-center justify-center text-white hover:bg-podipoint-orange transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="order-1 md:order-2">
            <div className="bg-white p-2 rounded-3xl shadow-lg overflow-hidden">
              <div className="aspect-square w-full rounded-2xl overflow-hidden">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3668.3716971716044!2d75.78665337637162!3d23.15663027908009!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39637551bf69dcdf%3A0xaf70afae3773ba73!2sPodi%20Point%20-%20True%20South%20Indian!5e0!3m2!1sen!2sin!4v1745232356426!5m2!1sen!2sin" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
